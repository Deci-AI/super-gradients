...
animalpose_gridsearch:
	CUDA_VISIBLE_DEVICES=0 python -m src/super_gradients/train_from_recipe.py --config-name=animalpose_yolo_nas_pose_s_grid_search arch_params.heads.YoloNASPoseNDFLHeads.compensate_grid_cell_offset=False arch_params.heads.YoloNASPoseNDFLHeads.box_center_is_anchor_point=False arch_params.heads.YoloNASPoseNDFLHeads.pose_offset_multiplier=1.0 dataset_params=animalpose_pose_estimation_yolo_nas_pose_dataset_params,animalpose_pose_estimation_yolo_nas_mosaic_pose_dataset_params &
	CUDA_VISIBLE_DEVICES=1 python -m src/super_gradients/train_from_recipe.py --config-name=animalpose_yolo_nas_pose_s_grid_search arch_params.heads.YoloNASPoseNDFLHeads.compensate_grid_cell_offset=False arch_params.heads.YoloNASPoseNDFLHeads.box_center_is_anchor_point=True  arch_params.heads.YoloNASPoseNDFLHeads.pose_offset_multiplier=1.0 dataset_params=animalpose_pose_estimation_yolo_nas_pose_dataset_params,animalpose_pose_estimation_yolo_nas_mosaic_pose_dataset_params &
	CUDA_VISIBLE_DEVICES=2 python -m src/super_gradients/train_from_recipe.py --config-name=animalpose_yolo_nas_pose_s_grid_search arch_params.heads.YoloNASPoseNDFLHeads.compensate_grid_cell_offset=True  arch_params.heads.YoloNASPoseNDFLHeads.box_center_is_anchor_point=False arch_params.heads.YoloNASPoseNDFLHeads.pose_offset_multiplier=1.0 dataset_params=animalpose_pose_estimation_yolo_nas_pose_dataset_params,animalpose_pose_estimation_yolo_nas_mosaic_pose_dataset_params &
	CUDA_VISIBLE_DEVICES=3 python -m src/super_gradients/train_from_recipe.py --config-name=animalpose_yolo_nas_pose_s_grid_search arch_params.heads.YoloNASPoseNDFLHeads.compensate_grid_cell_offset=True  arch_params.heads.YoloNASPoseNDFLHeads.box_center_is_anchor_point=True  arch_params.heads.YoloNASPoseNDFLHeads.pose_offset_multiplier=1.0 dataset_params=animalpose_pose_estimation_yolo_nas_pose_dataset_params,animalpose_pose_estimation_yolo_nas_mosaic_pose_dataset_params &

	CUDA_VISIBLE_DEVICES=4 python -m src/super_gradients/train_from_recipe.py --config-name=animalpose_yolo_nas_pose_s_grid_search arch_params.heads.YoloNASPoseNDFLHeads.compensate_grid_cell_offset=False arch_params.heads.YoloNASPoseNDFLHeads.box_center_is_anchor_point=False arch_params.heads.YoloNASPoseNDFLHeads.pose_offset_multiplier=2.0 dataset_params=animalpose_pose_estimation_yolo_nas_pose_dataset_params,animalpose_pose_estimation_yolo_nas_mosaic_pose_dataset_params &
	CUDA_VISIBLE_DEVICES=5 python -m src/super_gradients/train_from_recipe.py --config-name=animalpose_yolo_nas_pose_s_grid_search arch_params.heads.YoloNASPoseNDFLHeads.compensate_grid_cell_offset=False arch_params.heads.YoloNASPoseNDFLHeads.box_center_is_anchor_point=True  arch_params.heads.YoloNASPoseNDFLHeads.pose_offset_multiplier=2.0 dataset_params=animalpose_pose_estimation_yolo_nas_pose_dataset_params,animalpose_pose_estimation_yolo_nas_mosaic_pose_dataset_params &
	CUDA_VISIBLE_DEVICES=6 python -m src/super_gradients/train_from_recipe.py --config-name=animalpose_yolo_nas_pose_s_grid_search arch_params.heads.YoloNASPoseNDFLHeads.compensate_grid_cell_offset=True  arch_params.heads.YoloNASPoseNDFLHeads.box_center_is_anchor_point=False arch_params.heads.YoloNASPoseNDFLHeads.pose_offset_multiplier=2.0 dataset_params=animalpose_pose_estimation_yolo_nas_pose_dataset_params,animalpose_pose_estimation_yolo_nas_mosaic_pose_dataset_params &
	CUDA_VISIBLE_DEVICES=7 python -m src/super_gradients/train_from_recipe.py --config-name=animalpose_yolo_nas_pose_s_grid_search arch_params.heads.YoloNASPoseNDFLHeads.compensate_grid_cell_offset=True  arch_params.heads.YoloNASPoseNDFLHeads.box_center_is_anchor_point=True  arch_params.heads.YoloNASPoseNDFLHeads.pose_offset_multiplier=2.0 dataset_params=animalpose_pose_estimation_yolo_nas_pose_dataset_params,animalpose_pose_estimation_yolo_nas_mosaic_pose_dataset_params &
