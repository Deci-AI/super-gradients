...
coco2017_yolo_nas_pose_s_mosaic_no_offset_compensation_local:
	python src/super_gradients/train_from_recipe.py --config-name=coco2017_yolo_nas_pose_s_mosaic_no_offset_compensation_local \
    batch_size=56 num_gpus=4 \
    dataset_params.train_dataset_params.data_dir=/home/bloodaxe/data/coco2017 \
...
coco2017_yolo_nas_pose_s_mosaic_v3_weights_and_biases:
	python src/super_gradients/train_from_recipe.py --config-name=coco2017_yolo_nas_pose_s_mosaic_v3_weights_and_biases
