...
with-min_samples:
	CUDA_VISIBLE_DEVICES=1 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m_with_min_samples dataset_name=bacteria-ptywi 		 dataset_params=roboflow_detection_v2_dataset_params training_hyperparams.lr_warmup_epochs=3 training_hyperparams.warmup_mode=linear_epoch_step training_hyperparams.initial_lr=5e-4 experiment_suffix=1  training_hyperparams.ema=False &
	CUDA_VISIBLE_DEVICES=0 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m_with_min_samples dataset_name=cells-uyemf    		 dataset_params=roboflow_detection_v2_dataset_params training_hyperparams.lr_warmup_epochs=3 training_hyperparams.warmup_mode=linear_epoch_step training_hyperparams.initial_lr=5e-4 experiment_suffix=0  training_hyperparams.ema=False &
	CUDA_VISIBLE_DEVICES=2 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m_with_min_samples dataset_name=solar-panels-taxvb    dataset_params=roboflow_detection_v2_dataset_params training_hyperparams.lr_warmup_epochs=3 training_hyperparams.warmup_mode=linear_epoch_step training_hyperparams.initial_lr=5e-4 experiment_suffix=2  training_hyperparams.ema=False &
	CUDA_VISIBLE_DEVICES=3 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m_with_min_samples dataset_name=farcry6-videogame     dataset_params=roboflow_detection_v2_dataset_params training_hyperparams.lr_warmup_epochs=3 training_hyperparams.warmup_mode=linear_epoch_step training_hyperparams.initial_lr=5e-4 experiment_suffix=3  training_hyperparams.ema=False &
	CUDA_VISIBLE_DEVICES=4 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m_with_min_samples dataset_name=aerial-pool    		 dataset_params=roboflow_detection_v2_dataset_params training_hyperparams.lr_warmup_epochs=3 training_hyperparams.warmup_mode=linear_epoch_step training_hyperparams.initial_lr=5e-4 experiment_suffix=4  training_hyperparams.ema=False &
	CUDA_VISIBLE_DEVICES=5 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m_with_min_samples dataset_name=soccer-players-5fuqs  dataset_params=roboflow_detection_v2_dataset_params training_hyperparams.lr_warmup_epochs=3 training_hyperparams.warmup_mode=linear_epoch_step training_hyperparams.initial_lr=5e-4 experiment_suffix=5  training_hyperparams.ema=False &
	CUDA_VISIBLE_DEVICES=6 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m_with_min_samples dataset_name=tweeter-posts    	 dataset_params=roboflow_detection_v2_dataset_params training_hyperparams.lr_warmup_epochs=3 training_hyperparams.warmup_mode=linear_epoch_step training_hyperparams.initial_lr=5e-4 experiment_suffix=6  training_hyperparams.ema=False &
	CUDA_VISIBLE_DEVICES=7 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m_with_min_samples dataset_name=cotton-20xz5    		 dataset_params=roboflow_detection_v2_dataset_params training_hyperparams.lr_warmup_epochs=3 training_hyperparams.warmup_mode=linear_epoch_step training_hyperparams.initial_lr=5e-4 experiment_suffix=7  training_hyperparams.ema=False &
