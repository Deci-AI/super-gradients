...
coco2017_yolo_nas_pose_s:
	...
	python src/super_gradients/train_from_recipe.py --config-name=coco2017_yolo_nas_pose_s_weights_and_biases multi_gpu=Off num_gpus=1
...
coco2017_yolo_nas_pose_l:
	python src/super_gradients/train_from_recipe.py --config-name=coco2017_yolo_nas_pose_l_weights_and_biases batch_size=24
