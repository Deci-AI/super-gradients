cells-uyemf:
	CUDA_VISIBLE_DEVICES=0 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m dataset_name=cells-uyemf +training_hyperparams.ema_params.beta=15 training_hyperparams.ema_params.decay_type=exp &
	CUDA_VISIBLE_DEVICES=1 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m dataset_name=cells-uyemf +training_hyperparams.ema_params.beta=15 training_hyperparams.ema_params.decay_type=exp training_hyperparams.initial_lr=1e-4 &
	CUDA_VISIBLE_DEVICES=2 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m dataset_name=cells-uyemf +training_hyperparams.ema_params.beta=15 training_hyperparams.ema_params.decay_type=exp training_hyperparams.initial_lr=3e-4 &
	CUDA_VISIBLE_DEVICES=3 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m dataset_name=cells-uyemf +training_hyperparams.ema_params.beta=15 training_hyperparams.ema_params.decay_type=exp training_hyperparams.initial_lr=5e-4 &
	CUDA_VISIBLE_DEVICES=4 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m dataset_name=cells-uyemf +training_hyperparams.ema_params.beta=15 training_hyperparams.ema_params.decay_type=exp training_hyperparams.lr_warmup_steps=0 &
	CUDA_VISIBLE_DEVICES=5 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m dataset_name=cells-uyemf +training_hyperparams.ema_params.beta=15 training_hyperparams.ema_params.decay_type=exp training_hyperparams.optimizer=SGD training_hyperparams.initial_lr=1e-3 &
	CUDA_VISIBLE_DEVICES=6 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m dataset_name=cells-uyemf training_hyperparams.ema=False &
	CUDA_VISIBLE_DEVICES=7 python -m super_gradients.train_from_recipe --config-name=roboflow_deciyolo_m dataset_name=cells-uyemf +training_hyperparams.ema_params.beta=15 training_hyperparams.ema_params.decay_type=exp training_hyperparams.ema_params.decay=0.99 &
