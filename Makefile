...
test:
	python src/super_gradients/train_from_recipe.py --config-name=coco2017_yolo_nas_pose_s dataset_params=coco_pose_estimation_yolo_nas_dataset_params                  training_hyperparams.max_train_batches=512 training_hyperparams.max_valid_batches=512 training_hyperparams.max_epochs=1 dataset_params.train_dataset_params.data_dir=/home/bloodaxe/data/coco2017 dataset_params.val_dataset_params.data_dir=/home/bloodaxe/data/coco2017 num_gpus=4
	python src/super_gradients/train_from_recipe.py --config-name=coco2017_yolo_nas_pose_s dataset_params=coco_pose_estimation_yolo_nas_rescale_dataset_params          training_hyperparams.max_train_batches=512 training_hyperparams.max_valid_batches=512 training_hyperparams.max_epochs=1 dataset_params.train_dataset_params.data_dir=/home/bloodaxe/data/coco2017 dataset_params.val_dataset_params.data_dir=/home/bloodaxe/data/coco2017 num_gpus=4
	...
	python src/super_gradients/train_from_recipe.py --config-name=coco2017_yolo_nas_pose_s dataset_params=coco_pose_estimation_yolo_nas_mixup_dataset_params            training_hyperparams.max_train_batches=512 training_hyperparams.max_valid_batches=512 training_hyperparams.max_epochs=1 dataset_params.train_dataset_params.data_dir=/home/bloodaxe/data/coco2017 dataset_params.val_dataset_params.data_dir=/home/bloodaxe/data/coco2017 num_gpus=4
