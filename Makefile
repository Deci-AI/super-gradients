...
coco2017_yolo_nas_pose_s_mixup_no_offset_compensation_weights_and_biases:
	python src/super_gradients/train_from_recipe.py --config-name=coco2017_yolo_nas_pose_s_mixup_no_offset_compensation_weights_and_biases training_hyperparams.sync_bn=False batch_size=56
