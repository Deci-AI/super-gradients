...
| PP-YOLOE small        | ppyoloe_s             | COCO    | 640x640    | 42.52                    | **2.39ms**                    | **4.3ms**                           | **14.28ms**                              | **14.99ms**                                       |              **-**              |                             TBD |
| PP-YOLOE medium       | ppyoloe_m             | COCO    | 640x640    | 47.11                    | **5.16ms**                    | **7.05ms**                          | **32.71ms**                              | **33.46ms**                                       |              **-**              |                             TBD |
| PP-YOLOE large        | ppyoloe_l             | COCO    | 640x640    | 49.48                    | **7.65ms**                    | **9.59ms**                          | **51.13ms**                              | **50.39ms**                                       |              **-**              |                             TBD |
| PP-YOLOE x-large      | ppyoloe_x             | COCO    | 640x640    | 51.15                    | **14.04ms**                   | **15.96ms**                         | **94.92ms**                              | **94.22ms**                                       |              **-**              |                             TBD |
...
| SSD lite MobileNet v2 | ssd_lite_mobilenet_v2 | COCO    | 320x320    | 21.5                     | **0.77ms**                    | **1.40ms**                          | **5.28ms**                               | **6.44ms**                                        |           **4.13ms**            |                             TBD |
| SSD lite MobileNet v1 | ssd_mobilenet_v1      | COCO    | 320x320    | 24.3                     | **1.55ms**                    | **2.84ms**                          | **8.07ms**                               | **9.14ms**                                        |           **22.76ms**           |                             TBD |
