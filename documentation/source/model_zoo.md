...
| YOLOX nano            | yolox_n               | COCO    | 640x640    | 26.77                    | **2.47ms**                    | **4.09ms**                          | **11.49ms**                              | **12.97ms**                                       |              **-**              |                     TBD |
| YOLOX tiny            | yolox_t               | COCO    | 640x640    | 37.18                    | **3.16ms**                    | **4.61ms**                          | **15.23ms**                              | **19.24ms**                                       |              **-**              |                     TBD |
| YOLOX small           | yolox_s               | COCO    | 640x640    | 40.47                    | **3.58ms**                    | **4.94ms**                          | **18.88ms**                              | **22.48ms**                                       |              **-**              |                     TBD |
| YOLOX medium          | yolox_m               | COCO    | 640x640    | 46.4                     | **6.40ms**                    | **7.65ms**                          | **39.22ms**                              | **44.5ms**                                        |              **-**              |                     TBD |
| YOLOX large           | yolox_l               | COCO    | 640x640    | 49.25                    | **10.07ms**                   | **11.12ms**                         | **68.73ms**                              | **77.01ms**                                       |              **-**              |                     TBD |
