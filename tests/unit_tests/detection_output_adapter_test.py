    ...
    def test_output_adapter_can_be_onnx_exported(self):
        ...
        for inp in example_inputs:
            ...
            with tempfile.TemporaryDirectory() as tmpdirname:
                ...
                torch.onnx.export(adapter, inp, f=adapter_fname, input_names=["results"], output_names=["output_predictions"], opset_version=11)
                ...
                actual_output = ort_sess.run(None, {"results": inp.numpy()})[0]
