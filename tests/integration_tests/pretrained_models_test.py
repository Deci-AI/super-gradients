...
class PretrainedModelsTest(unittest.TestCase):
    ...
    def test_pretrained_yolov5s_coco(self):
        trainer = Trainer('coco_pretrained_yolov5s', model_checkpoints_location='local',
                          multi_gpu=MultiGPUMode.OFF)
    ...
    def test_pretrained_yolov5m_coco(self):
        trainer = Trainer('coco_pretrained_yolov5m', model_checkpoints_location='local',
                          multi_gpu=MultiGPUMode.OFF)
        trainer.connect_dataset_interface(self.coco_dataset['yolo_v5'], data_loader_num_workers=8)
    ...
    def test_pretrained_yolov5l_coco(self):
        trainer = Trainer('coco_pretrained_yolov5l', model_checkpoints_location='local',
                          multi_gpu=MultiGPUMode.OFF)
        trainer.connect_dataset_interface(self.coco_dataset['yolo_v5'], data_loader_num_workers=8)
    ...
    def test_pretrained_yolov5n_coco(self):
        trainer = Trainer('coco_pretrained_yolov5n', model_checkpoints_location='local',
                          multi_gpu=MultiGPUMode.OFF)
        trainer.connect_dataset_interface(self.coco_dataset['yolo_v5'], data_loader_num_workers=8)
