...
## Pytorch-base, compatible with deployment tools, SOTA models to use, train and fine-tune easily with cutting edge features
...
SuperGradients allows you to use, train or fine-tune SOTA pre-trained models for all the most commonly applied computer vision tasks. 
...
Easily load, use or fine-tune production-ready, [pre-trained SOTA models](https://github.com/Deci-AI/super-gradients#pretrained-classification-pytorch-checkpoints)
    
**Get the most out of your model with our training recipes and advanced features**
       
Tested and proven [recipes](https://github.com/Deci-AI/super-gradients/tree/master/src/super_gradients/recipes) & [code examples](https://github.com/Deci-AI/super-gradients/tree/master/src/super_gradients/examples) for a wide range of computer vision models generated by our team of deep learning experts.
    
**Production Readiness**
    
The models are compatible with deployment tools such as TensorRT (Nvidia) and OpenVINO (Intel) and can be easily taken into production.

**Choose a model that fit your required Performance per HW**

Cheack [models' latency](https://github.com/Deci-AI/super-gradients#computer-vision-models---pretrained-checkpoints)  on T4, Jetson Xavier NX and Cascade Lake
...
sg_model.predict(inputs=<PATH_TO_IMAGE>)
```   
...
> **NOTE:** For resolutions bellow 1024x2048 we first resize the input to the inference resolution and then resize the predictions to 1024x2048. The time of resizing is included in the measurements so that the practical input-size is 1024x2048.
