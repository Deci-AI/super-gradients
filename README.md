...
## README - unstructured.io sections
...
For now in _unstructured-io_ space we have following volumes:

* **unstructured_jan24** - with 5k samples dataset gathered in January '24
* **volume-doclaynet** - with DocLayNet dataset
