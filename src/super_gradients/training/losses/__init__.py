...
from super_gradients.training.losses.all_losses import LOSSES, LossNames

__all__ = ['LOSSES', 'LossNames', 'FocalLoss', 'LabelSmoothingCrossEntropyLoss', 'ShelfNetOHEMLoss', 'ShelfNetSemanticEncodingLoss',
