...
from super_gradients.training.datasets.detection_datasets import COCODetectionDataset,PascalVOCDetectionDataSetV2
...
__all__ = ['DataAugmentation', 'ListDataset', 'DirectoryDataSet', 'CLASSIFICATION_DATASETS', 'OBJECT_DETECTION_DATASETS',
           ...
           'COCODetectionDataset', 'PascalVOCDetectionDataSetV2']
