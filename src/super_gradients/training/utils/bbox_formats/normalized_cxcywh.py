...
from super_gradients.training.utils.bbox_formats.cxcywh import cxcywh_to_xyxy, xyxy_to_cxcywh_inplace, cxcywh_to_xyxy_inplace, xyxy_to_cxcywh
...
def xyxy_to_normalized_cxcywh(bboxes, image_shape: Tuple[int, int]):
    ...
    return xyxy_to_cxcywh(normalized_xyxy, image_shape)  # Can be done inplace
