...
class Trainer:
    ...
    def train_from_config(cls, cfg: Union[DictConfig, dict]) -> Tuple[nn.Module, Tuple]:
        ...
        setup_gpu_mode(
            gpu_mode=core_utils.get_param(cfg, "multi_gpu", MultiGPUMode.OFF),
    ...
    def train(
        ...
        # SET RANDOM SEED
        random_seed(
            is_ddp=self.multi_gpu == MultiGPUMode.DISTRIBUTED_DATA_PARALLEL,
            device=self.device,
        ...
        if not self.ddp_silent_mode:
            # TODO: The earlier we initialize loggers,
            # TODO: the more messages will land in experiment_dir/log_XX_YY_ZZ.txt
        ...
        # Always want to catch exception, regardless of silent mode
