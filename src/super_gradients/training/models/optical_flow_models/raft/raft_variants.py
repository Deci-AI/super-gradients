...
Code and KITTI pre-trained weights adopted from GitHub repo:
https://github.com/princeton-vl/RAFT/tree/3fa0bb0a9c633ea0a9bb8a79c576b6785d4e6a02
"""
...
class RAFT(ExportableOpticalFlowModel, SgModule):
    def __init__(self, in_channels, encoder_params, corr_params, flow_params, num_classes):
        ...
        self.feature_encoder = Encoder(
            ...
            block=encoder_params.fnet.block,
        ...
        self.context_encoder = ContextEncoder(
            in_channels=self.in_channels,
            in_planes=encoder_params.in_planes,
            block=encoder_params.cnet.block,
    ...
    def forward(self, x):
        ...
        :param x: Input image pair of shape [B,2,C,H,W], order prev/curr.
        :return: Flow predictions for each input image pair. During training, the predicted flow will be a list of flow
        predictions of length equal to the number of iterations in the FlowIterativeBlock.
        """
