...
@deprecated(deprecated_since="3.1.0", removed_from="4.0.0", target=_make_divisible_current_version)
...
@deprecated(deprecated_since="3.1.0", removed_from="4.0.0", target=BasicResNetBlock, reason="This block was renamed to BasicResNetBlock for better clarity.")
class BasicBlock(BasicResNetBlock):
    ...


@deprecated(deprecated_since="3.1.0", removed_from="4.0.0", target=NewBottleneck, reason="This block was renamed to BasicResNetBlock for better clarity.")
class Bottleneck(NewBottleneck):
    ...


@deprecated(deprecated_since="3.1.0", removed_from="4.0.0", target=CurrVersionHpmStruct)
