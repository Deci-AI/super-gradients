...
from super_gradients.training.models.detection_models.yolo_base import YoloBase, YoloDarknetBackbone, YoloX_MAR24_1_1, YoloX_MAR24_2_1
...
# It's YoloX-L obtained during CORE-4026 with
# post-processing callback hardcoded for best parameters identified in CORE-4051
@register_model(Models.YOLOX_MAR24_2_1)
class YoloX_L_MAR24_2_1(YoloX_MAR24_2_1):
    def __init__(self, arch_params: HpmStruct):
        arch_params.depth_mult_factor = 1.0
        arch_params.width_mult_factor = 1.0
        arch_params.yolo_type = "yoloX"
