...
def get_yolo_version_params(yolo_type: str, width_mult_factor: float, depth_mult_factor: float):
    if yolo_type == 'yoloX':
        struct = (3, 9, 9, 3)
        block = CSPLayer
...
class CSPDarknet53(SgModule):
    def __init__(self, arch_params: HpmStruct):
        ...
        if get_param(arch_params, 'stem_type') == '6x6' or yolo_type == 'yoloX' or yolo_version == 'v6.0':
