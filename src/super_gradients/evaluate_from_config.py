...
General use: python -m super_gradients.evaluate_from_config --config-name="DESIRED_RECIPE".
...
python -m super_gradients.evaluate_from_config --config-name="DESIRED_RECIPE" training_hyperparams.ckpt_name=average_model.pth
