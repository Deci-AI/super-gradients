...
#
# Example usage:
# dota_predict_test_dev.py yolo_nas_r_s --checkpoint_path=checkpoints/yolo_nas_r_s_dota2_best.pth --images_dir=/path/to/DOTA-v2.0/test-dev/images
...
def main():
    ...
    args.add_argument("--images_dir", type=str, required=True, help="Path to the images directory with DOTA test-dev images")
    args.add_argument("--num-classes", type=int, default=18, help="Number of classes in the model")
    args.add_argument("--pretrained_weights", type=str, default=None, help="Path to the pretrained weights file")
    args.add_argument("--checkpoint_path", type=str, default=None, help="Path to the model checkpoint")
    ...
    if checkpoint_path is None and pretrained_weights is None:
        print("Either checkpoint_path or pretrained_weights should be provided")
        return 1
    ...
    if submission_dir is None:
        if checkpoint_path is not None:
            ...
            print("A --submission_dir parameter should be provided if using pretrained weights without a checkpoint file")
    ...
    # Load model
    model = models.get(model_name, checkpoint_path=checkpoint_path, pretrained_weights=pretrained_weights, num_classes=num_classes)
