...
model.build_model("resnet18", checkpoint_params={"pretrained_weights": "imagenet"}, arch_params={"use_quant_modules": True})
...
train_params = {"max_epochs": 1,
                ...
                "phase_callbacks": [Int8CalibrationPreTrainingCallback()]}
