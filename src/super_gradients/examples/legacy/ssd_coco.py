...
epoch_metrics_headers = {
    "Epoch": 0, "gpu_mem": 0.0, "sl1": 0.0, "closs": 0.0, "total": 0.0,
...
training_params = {
    ...
    "valid_metrics_list": [
        DetectionMetrics(num_cls=80, post_prediction_callback=SSDPostPredictCallback(dboxes=dboxes))
