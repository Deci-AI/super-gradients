...
@hydra.main(config_path=pkg_resources.resource_filename("super_gradients.recipes", ""), version_base="1.1")
def main(cfg: DictConfig):
    ...
    if not multi_gpu or multi_gpu == MultiGPUMode.OFF:
        ...
        subprocesses = launch_sub_processes(ddp_port, world_size=n_proc_node) if local_rank == 0 else []
