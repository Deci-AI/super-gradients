...
#     """
#     import runpy
#     runpy.run_module("super_gradients.examples.train_from_recipe_example.train_from_recipe", run_name="__main__")
#
#
# def run(args, cfg):
#     if args.standalone:
...
#     # config = LaunchConfig(min_nodes=1, max_nodes=1, nproc_per_node=3, run_id='none', role='default', rdzv_endpoint='127.0.0.1:29500', rdzv_backend='static',
#     #              rdzv_configs={'rank': 0, 'timeout': 900}, rdzv_timeout=-1, max_restarts=0, monitor_interval=5, start_method='spawn', log_dir=None,
#     #              redirects=Std.NONE, tee=Std.NONE, metrics_cfg = {})
#     config = LaunchConfig(
#         min_nodes=1,
#         max_nodes=1,
#         nproc_per_node=3,
...
#
#     elastic_launch(config=config, entrypoint=run_script_path)()
#
#     # elastic_launch(config=config, entrypoint=pkg_resources.resource_filename("super_gradients.recipes", ""))(pkg_resources.resource_filename("super_gradients.recipes", ""), "imagenet_efficientnet")
#
#
# import os
# import hydra
...
# def run_script_path(*training_script_args: str):
    """
    Runs the provided `training_script` from within this interpreter.
    Usage: `script_as_function("/abs/path/to/script.py", "--arg1", "val1")`
    """
...
def run(cfg):
    ...
    training_script = pkg_resources.resource_filename(
    ...
    args = sys.argv[1:]
    elastic_launch(config=config, entrypoint=sys.executable)(training_script, *args)
